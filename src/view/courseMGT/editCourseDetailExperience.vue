              ...
              <Card title="基础信息">
                <FormItem label="课程类型：" prop="account">
                  <RadioGroup v-model="formItem.radio">
                    <Radio label="团课">团课</Radio>
                    <Radio label="体验卡">体验卡</Radio>
                  </RadioGroup>
                </FormItem>
...
<!--                  <p style="color: #5cadff;text-align: right;margin-top: -50px;margin-bottom: 42px;" @click.stop="modal = true"> + 新增规格</p>-->
<!--                  <div style="overflow: hidden" v-for="(item,index) of sizeList">-->
<!--                    <p class="skuBox float_l">{{ item.title }}</p>-->
<!--                    <p class="float_l" style="margin: 26px 0 0 28px;color: #c8241b" @click="deleteRender(index)">-->
<!--                      删除规格</p>-->
<!--                  </div>-->
<!--                </Card>-->
<!--              </Col>-->
...
<!--              </Card>-->
<!--            </Col>-->
            <Col span="14" style="margin-top: 22px;">
              <Card title="课程表">
...
export default {
  ...
  mounted () {
    if (this.$route.query.id) this.title = '编辑体验课详情'
    this.getlist(1)
