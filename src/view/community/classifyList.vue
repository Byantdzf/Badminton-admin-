    ...
    <div v-model="activeTab">
      <Card>
        <Tabs @on-click="getTab">
          <TabPane label="社群列表" name="association">
            <Input
            ...
            <Card>
              ...
              <Page :total="orgTotal" @on-change="handlePage" :page-size="100"
...
export default {
  ...
  methods: {
    ...
    getlist (page) {
      let self = this
      self.loading = true
      uAxios.get(`admin/community/groups/` + self.id + `?page=${page}&status=${self.activeTab}&keyword=${self.searchKeyword}`)
        .then(res => {
          ...
          self.loading = false
          console.log(self.orgTotal, '8585')
        })
    },
    deleteUser () {
      let self = this
